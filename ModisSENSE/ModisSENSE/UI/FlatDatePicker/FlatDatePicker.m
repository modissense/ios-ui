...
*/
#define kFlatDatePickerBackgroundColor [UIColor colorWithRed:180.0/255.0 green:180.0/255.0 blue:180.0/255.0 alpha:0.5]
#define kFlatDatePickerBackgroundColorTitle [UIColor clearColor]
#define kFlatDatePickerBackgroundColorButtonValid [UIColor clearColor]
#define kFlatDatePickerBackgroundColorButtonCancel [UIColor clearColor]
#define kFlatDatePickerBackgroundColorScrolView [UIColor clearColor]
#define kFlatDatePickerBackgroundColorLines DEFAULTBLUE
...
*/
#define kFlatDatePickerFontColorTitle DEFAULTBLUE
#define kFlatDatePickerFontColorLabel [UIColor blackColor]
#define kFlatDatePickerFontColorLabelSelected [UIColor colorWithRed:51.0/255.0 green:181.0/255.0 blue:229.0/255.0 alpha:1.0]
...
#define kFlatDatePickerFontTitle CELLFONTBOLD
#define kFlatDatePickerFontLabel CELLFONT
#define kFlatDatePickerFontLabelSelected CELLFONTBOLD

// Constants icons
#define kFlatDatePickerIconCancel @"remove"
#define kFlatDatePickerIconValid @"add"
