...
- (void)initalizeInputView {
    ...
    // Eng.search.criteria.from = self.dateValue;
    // Eng.search.criteria.to = self.dateValue;
...
- (void)done:(id)sender {
    ...
    [self setDateValueAndCallDelegate:self.dateValue timerValue:self.timerValue];
}
...
- (BOOL)becomeFirstResponder {
    ...
    if (self.datePickerMode == UIDatePickerModeCountDownTimer) {
        ...
        self.datePicker.date = [self isNull:self.dateValue] ? [NSDate date] : self.dateValue;
    }
...
- (void)dateChanged:(id)sender {
    [self setDateValueAndCallDelegate:((UIDatePicker *)sender).date timerValue:((UIDatePicker *)sender).countDownDuration];
}

-(void)setDateValueAndCallDelegate: (NSDate *)selectedDate timerValue:(NSTimeInterval)timerValue {
